...
// Start Transport on testSong click
const testSong = document.getElementById('testSong');
testSong.addEventListener("click", e => {
    if (testSong.playing === 'false') {
        // Change play status
        testSong.playing = 'true';
        ...
        // Update testSong text
        testSong.innerText = "Stop Song";
    } else {
        // Change play status
        testSong.playing = 'false';
